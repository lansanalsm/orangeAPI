				 ...
				 $requete = $bdd->query('SELECT * FROM t_region');
				  echo"Choisissez une localité SVP.<br/>";
					while($tmp = $requete->fetch()) { 
					  echo"<a href='affiche-demande.php?region=$tmp[id_region]'>$tmp[nom]</a><br/>";
					  }
				$requete->closeCursor();
			...
			try{ require('../../inc/connection_bd.php');
				 $requete = $bdd->query('SELECT * FROM t_categorie_produit');
				  echo"Choisissez une categorie SVP.<br/>";
					while($tmp = $requete->fetch()) { 
					  echo"<a href='affiche-demande.php?categorie=$tmp[id_cat]'>$tmp[nom]</a><br/>";
					  }
				$requete->closeCursor();
			   }catch(Exception $e){ die('Erreur : '.$e->getMessage());}
		 break;	
			  ...
			  if($requete2->rowCount()>0){
				...
				echo"Choisissez l'une des ville de $x[region]<br/>";
				 while($tmp=$requete2->fetch()){
				  echo"<a href='affiche-demande.php?ville=$tmp[id_ville]'>$tmp[ville]</a><br/>";
				}//while
			  }else{
		...
		require('../../inc/connection_bd.php');
			  ...
			  if($requete2->rowCount()>0){
				...
				echo"Choisissez l'une des categories de $x[categorie]<br/>";
				 while($tmp=$requete2->fetch()){
				  echo"<a href='affiche-demande.php?sous_cat=$tmp[id_sous_cat]'>$tmp[sous_categorie]</a><br/>";
				}//while
			  }else{
	...
	try{
			require('../../inc/connection_bd.php');
			 ...
			 if($nb>0 ){
			   ...
			   $msg="Aucune demande pour la ville selectionnee";
	 ...
	 if(isset($_GET['abonnement']) && !empty($_GET['abonnement'])){
		...
		if(isset($_GET['confirm'])&& $_GET['confirm']==true){
			   ...
			   echo"<a href='affiche-demande.php?ville=$ville&amp;change=1&amp;abonnement=$abonnement&amp;confirm=true'>Confirmer</a><br/>";
			   echo"<a href='affiche-demande.php?ville=$ville'>Annuler</a><br/>";
		 ...
		 echo"<a href='affiche-demande.php?ville=$ville&amp;change=1&amp;abonnement=1'>Abonnement journalier(500F)</a><br/>";
		 echo"<a href='affiche-demande.php?ville=$ville&amp;change=1&amp;abonnement=2'>Abonnement Somaire(2500F)</a><br/>";
		 echo"<a href='affiche-demande.php?ville=$ville&amp;change=1&amp;abonnement=3'>Abonnement Mensuel(10000F)</a><br/>";
		 echo"<a href='affiche-demande.php?ville=$ville&amp;change=1&amp;abonnement=4'>Abonnement Annuel(100000F)</a><br/>";
    }
	 ...
	 echo"<a href='affiche-demande.php?ville=$ville&amp;nombre=1'>La derniere demande (200F)</a><br/>";
	 echo"<a href='affiche-demande.php?ville=$ville&amp;nombre=3'>Les 3 dernieres demandes (175F/prdt)</a><br/>";
	 echo"<a href='affiche-demande.php?ville=$ville&amp;nombre=5'>Les 5 dernieres demandes (150F/prdt)</a><br/>";
	 echo"<a href='affiche-demande.php?ville=$ville&amp;nombre=10'>Les 10 derniers demandes (125F/prdt)</a><br/>";
	 echo"---------------<br/>";
	 echo"<a href='affiche-demande.php?ville=$ville&amp;change=1'>Abonnement</a><br/>";
	...
	try{
			require('../../inc/connection_bd.php');
			 ...
			 if($nb>0 ){
			   ...
			   $msg="Aucune demande pour la categorie selectionnee";
			   echo"$msg<br/>Merci d'avoir utilise makiti !";
		    }
	 ...
	 if(isset($_GET['abonnement']) && !empty($_GET['abonnement'])){
		...
		if(isset($_GET['confirm'])&& $_GET['confirm']==true){
			   ...
			   //traitement de la requette
				 ...
				 switch($abonnement){
					case 1:{
						 echo"Confirmer votre abonnement aux alertes de demandes journalieres.<br/>";
						 echo"<a href='affiche-demande.php?sous_cat=$sous_cat&amp;change=1&amp;abonnement=1&amp;confirm=true'>Confirmer</a><br/>";
						 echo"<a href='affiche-demande.php?sous_cat=$sous_cat'>Annuler</a><br/>";
						break;
					}
					case 2:{
						 echo"Confirmer votre abonnement aux alertes de demandes Sommaires.<br/>";
						 echo"<a href='affiche-demande.php?sous_cat=$sous_cat&amp;change=1&amp;abonnement=2&amp;confirm=true'>Confirmer</a><br/>";
						 echo"<a href='affiche-demande.php?sous_cat=$sous_cat'>Annuler</a><br/>";
						break;
					}
					case 3:{
						 echo"Confirmer votre abonnement aux alertes de demandes Mensuelles.<br/>";
						 echo"<a href='affiche-demande.php?sous_cat=$sous_cat&amp;change=1&amp;abonnement=3&amp;confirm=true'>Confirmer</a><br/>";
						 echo"<a href='affiche-demande.php?sous_cat=$sous_cat'>Annuler</a><br/>";
						break;
					}
					case 4:{
						 echo"Confirmer votre abonnement aux alertes de demandes Annuelles.<br/>";
						 echo"<a href='affiche-demande.php?sous_cat=$sous_cat&amp;change=1&amp;abonnement=4&amp;confirm=true'>Confirmer</a><br/>";
						 echo"<a href='affiche-demande.php?sous_cat=$sous_cat'>Annuler</a><br/>";
						break;
					}
				}//switech
		 ...
		 echo"Faite un choix svp.<br/>";
		 echo"<a href='affiche-demande.php?sous_cat=$sous_cat&amp;change=1&amp;abonnement=1'>Abonnement journalier(500F)</a><br/>";
		 echo"<a href='affiche-demande.php?sous_cat=$sous_cat&amp;change=1&amp;abonnement=2'>Abonnement Somaire(2500F)</a><br/>";
		 echo"<a href='affiche-demande.php?sous_cat=$sous_cat&amp;change=1&amp;abonnement=3'>Abonnement Mensuel(10000F)</a><br/>";
		 echo"<a href='affiche-demande.php?sous_cat=$sous_cat&amp;change=1&amp;abonnement=4'>Abonnement Annuel(100000F)</a><br/>";
    }
	 ...
	 echo"Faites un choix SVP.<br/>";
	 echo"<a href='affiche-demande.php?sous_cat=$sous_cat&amp;nombre=1'>La derniere demande (200F)</a><br/>";
	 echo"<a href='affiche-demande.php?sous_cat=$sous_cat&amp;nombre=3'>Les 3 dernieres demandes (175F/prdt)</a><br/>";
	 echo"<a href='affiche-demande.php?sous_cat=$sous_cat&amp;nombre=5'>Les 5 dernieres demandes (150F/prdt)</a><br/>";
	 echo"<a href='affiche-demande.php?sous_cat=$sous_cat&amp;nombre=10'>Les 10 derniers demandes (125F/prdt)</a><br/>";
	 echo"---------------<br/>";
	 echo"<a href='affiche-demande.php?sous_cat=$sous_cat&amp;change=1'>Abonnement</a><br/>";
	 // echo"votre numero est $numero";
...
if(isset($affiche_form) and $affiche_form==true){
	echo'Choissez la ville dans laquelle vous vous trouvez pour afficher les demandes de celle-ci<br/>';
	echo"<a href='affiche-demande.php?choix=1'>Afficher par localite</a><br/>";
	echo"<a href='affiche-demande.php?choix=2'>Afficher par Categorie</a><br/>";
	//echo"<a href='affiche-demande.php?choix=3'>Abonnement</a><br/>";
